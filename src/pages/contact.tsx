      ...
      <div className="contact-container">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="contact-form">
            ...
            <button type="submit" className="dropdown-btn">Submit</button>
          </form>
        )}
        <section className="lastquote">
          <p>
            "Money is a tool, not a goal. It should be used wisely, not hoarded aimlessly..."
          </p>
          <p className="writer">– Inspired by Seneca and modern reflections on wealth.</p>
        </section>
      </div>
      </div>
      <div className="chat">
